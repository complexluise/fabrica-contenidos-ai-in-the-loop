...
checkpoints. El detalle, los contratos y los diagramas están en [`ARCHITECTURE.md`](./ARCHITECTURE.md)
(el *qué/para-quién* en [`PRD.md`](./PRD.md)); el *por qué* de cada elección, en
[`docs/decisiones/`](./docs/decisiones/) (ADR numerados).
