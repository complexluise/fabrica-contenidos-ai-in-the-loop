# ROADMAP app (Studio) — histórico (fases cerradas)

> Archivo de las fases **cerradas** del track app (Fases 1–2.6). El índice y lo activo viven
> en [`../../app/ROADMAP.md`](../../app/ROADMAP.md). El *por qué* de cada elección está en
> [`../decisiones/`](../decisiones/). No se edita salvo corrección histórica.
