# ROADMAP pipeline — histórico (sprints cerrados)

> Archivo de los sprints **cerrados** del track pipeline (Sprints 1–6.37). El índice y lo
> activo viven en [`../../ROADMAP.md`](../../ROADMAP.md). El *por qué* de cada elección está
> en [`../decisiones/`](../decisiones/). No se edita salvo corrección histórica.
